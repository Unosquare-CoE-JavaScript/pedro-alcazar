/* 
 * Facade is an interface to access to a main body of code
 * this interface, must be easy and understable
 */
...
// This is the class that work as an interface to access to others services of others classes
class Console
{
  constructor()
  {
    //accessing to Buffer class
    this.buffer = new Buffer();
    //accessing to view class
