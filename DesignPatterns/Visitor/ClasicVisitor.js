/*
Propage an acept (Visitor) method throught the entire hierarchy
Create a visitor with visitFoo (Foo), vistBar(Bar) for each element in the hierarchy
Each accept() simply call visitor.visitXXX(this) 
*/
