...
// this is the class that change the state.
...
//the var cmd is the command to control the state of "ba" element, passed as an argument
let cmd = new BankAccountCommand(ba, Action.deposit, 50);
//This is the commando created to modifiy the state of the object
cmd.call();
